...
def main():
    ...
    # RTDE Stuff
    rtd = rtde_helper('record_configuration.xml', 'localhost', 30004, 125)
    ...
    pr = PyRep()
    pr.launch('/home/sarthak/PycharmProjects/pyrep_project/bill.ttt', headless=True)
    ...
    while sim_step <= STEPS:
        ...
        #ur10.set_joint_target_positions(np.random.randn(6, 1))
        ...
        if len(buffer) > 0:
            ...
            socket.send_pyobj([buff_stack, hum_position])
